...
class TestDataRobustness(unittest.TestCase):
    ...
    def test_missing_required_columns(self):
        ...
        with self.assertRaises(ValueError) as cm:
            IngestionService.ingest_file(csv_content, "missing_entity.csv")
        self.assertIn("Ambiguous Dataset Structure", str(cm.exception))

    def test_missing_optional_columns(self):
        """Test 101b: Missing Category (Should Pass)"""
        csv_content = b"Date,Vendor,Amount\n2023-01-01,TestVendor,100"
        result = IngestionService.ingest_file(csv_content, "missing_category.csv")
    ...
    def test_extra_columns(self):
        ...
        result = IngestionService.ingest_file(csv_content, "extra_cols.csv")
        self.assertEqual(result.rows_accepted, 1)
    ...
    def test_unit_k(self):
        ...
        result = IngestionService.ingest_file(csv_content, "units_k.csv")
        self.assertEqual(result.rows_accepted, 1)
    ...
    def test_unit_millions(self):
        ...
        IngestionService.ingest_file(csv_content, "units_m.csv")
    ...
    def test_empty_lines_and_duplicates(self):
        ...
        csv_content = b"Date,Vendor,Amount\n2023-01-01,V1,100\n\n\n2023-01-01,V1,100"
        result = IngestionService.ingest_file(csv_content, "duplicates.csv")
    ...
    def test_negative_values(self):
        ...
        csv_content = b"Date,Vendor,Amount\n2023-01-01,V1,-50.00"
        result = IngestionService.ingest_file(csv_content, "negative.csv")
        self.assertEqual(result.rows_accepted, 1)
    ...
    def test_ambiguous_columns(self):
        ...
        result = IngestionService.ingest_file(csv_content, "ambiguous.csv")
        self.assertEqual(result.rows_accepted, 1)
    ...
    def test_row_level_mixed_units(self):
        ...
        result = IngestionService.ingest_file(csv_content, "row_mixed.csv")

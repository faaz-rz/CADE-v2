...
import { ProcurementService, PriceComparisonResponse, PriceComparisonCategory } from '../services/api';
import { TrendingUp, TrendingDown, Minus, AlertTriangle, Package, DollarSign, Loader2 } from 'lucide-react';
